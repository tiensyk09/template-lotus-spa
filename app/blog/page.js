    ...
    <div style={{ backgroundColor: '#f6f3ea', minHeight: '100vh', padding: '40px 0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', fontSize: '13px', color: '#6b7280' }}>
          ...
          <span>/</span>
          <span style={{ color: '#5d7a3f', fontWeight: 600 }}>Cẩm nang nha khoa</span>
        </div>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: '#4b5563', fontSize: '15px', maxWidth: '600px', margin: '0 auto 24px', lineHeight: 1.6 }}>
            Cập nhật kiến thức chăm sóc răng miệng, các phương pháp điều trị hiện đại và ưu đãi mới nhất từ Lotus Spa.
          </p>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 0', background: '#ffffff', borderRadius: '16px', border: '1px solid #e5e7eb' }}>
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#445c2c', marginBottom: '8px' }}>Không tìm thấy bài viết nào</h3>
              ...
              >
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#5d7a3f', background: '#f1efe3', padding: '4px 10px', borderRadius: '999px', textTransform: 'uppercase' }}>
                      Cẩm nang
                    </span>
                  ...
                  {/* Title */}
                  <h3 style={{ fontSize: '18px', fontWeight: 700, lineHeight: 1.4, color: '#445c2c', margin: '0 0 12px 0' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #f3f4f6', paddingTop: '16px', marginTop: 'auto' }}>
                    <span style={{ fontSize: '12.5px', color: '#6b7280', fontWeight: 500 }}>
                      👤 {post.author_name || 'Lotus Spa'}
                    </span>
                    <Link href={`/posts/${post.slug}`} style={{ fontSize: '13px', fontWeight: 700, color: '#5d7a3f', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}>
      ...
      <style jsx global>{`
        ...
        .lc-spinner {
          width: 40px;
          height: 40px;
          border: 3.5px solid #f1efe3;
          border-top-color: #5d7a3f;
          border-radius: 50%;
