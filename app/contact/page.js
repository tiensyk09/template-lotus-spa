    ...
    <div style={{ backgroundColor: '#f6f3ea', minHeight: '100vh', padding: '40px 0' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', fontSize: '13px', color: '#6b7280' }}>
          ...
          <span>/</span>
          <span style={{ color: '#5d7a3f', fontWeight: 600 }}>Liên hệ</span>
        </div>

        {/* Page Header */}
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 800, color: '#445c2c', marginBottom: '12px', letterSpacing: '-0.02em' }}>
            Liên Hệ Với Chúng Tôi
          </h1>
          <p style={{ color: '#4b5563', fontSize: '15px', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
            Lotus Spa luôn sẵn sàng lắng nghe mọi thắc mắc và nhu cầu tư vấn nha khoa của quý khách. Hãy liên hệ với chúng tôi để được tư vấn chính gốc 100%.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '40px', alignItems: 'start' }} className="contact-grid">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ background: '#ffffff', borderRadius: '20px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)', display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#445c2c', margin: '0 0 6px 0' }}>Hotline / Zalo đặt hàng</h4>
                  <a href="tel:0769442777" style={{ fontSize: '18px', fontWeight: 800, color: '#5d7a3f', textDecoration: 'none' }}>0769.442.777</a>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#445c2c', margin: '0 0 6px 0' }}>Hòm thư điện tử</h4>
                  <p style={{ fontSize: '14px', color: '#4b5563', lineHeight: 1.5, margin: 0 }}>info@lotusspa.vn</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#445c2c', margin: '0 0 6px 0' }}>Trang thông tin điện tử</h4>
                  <p style={{ fontSize: '14px', color: '#4b5563', lineHeight: 1.5, margin: 0 }}>www.lotusspa.vn</p>
                </div>
              </div>
          ...
          <div style={{ background: '#ffffff', borderRadius: '20px', padding: '32px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
            <h3 style={{ fontSize: '22px', fontWeight: 800, color: '#445c2c', marginBottom: '20px' }}>Gửi tin nhắn cho chúng tôi</h3>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <button
                ...
                disabled={submitting}
                style={{
                  background: submitting ? '#6b7280' : '#5d7a3f',
                  color: '#ffffff',
                  padding: '12px 24px',
                  borderRadius: '30px',
                  border: 'none',
