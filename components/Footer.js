            ...
            <div>
              <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', marginBottom: 16 }}>
                ...
                <div style={{ lineHeight: 1 }}>
                  <Editable k="brand_name1" def="Lotus Spa" as="span" style={{ display: 'block', fontFamily: serif, fontSize: 22, fontWeight: 700, color: GREEN_DARK }} />
                  <Editable k="brand_name2" def="BEAUTY & RELAX" as="span" style={{ display: 'block', fontSize: 8, color: GOLD, letterSpacing: '0.4em', marginTop: 3, fontWeight: 700 }} />
                </div>
              </Link>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 13, fontSize: 13, fontWeight: 500, color: MUTED }}>
                ...
                <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                  ...
                  <Editable k="contact_phone" def="0901 234 567" as="span" style={{ color: GREEN_DARK, fontWeight: 800 }} />
                </li>
                <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                  ...
                  <Editable k="contact_email" def="lotusspa@gmail.com" as="span" />
                </li>
                <li style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                  ...
                  <Editable k="contact_hours" def="08:00 - 20:00 (T2 - CN)" as="span" />
                </li>
              </ul>
            </div>
